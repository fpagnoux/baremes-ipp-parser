...
class SummaryParser(object):
  ...
  def __init__(self, sheet, en_sheet, workbook_name, config):
    self.sheet = sheet
    self.en_sheet = en_sheet
    self.sheets_data = {}
  ...
  def parse_section_title(self, cell, current_section = None):
    ...
    description = self.clean_description(cell.internal_value)
    ...
    description_en = self.clean_description(self.en_sheet[cell.coordinate].internal_value)
  ...
  def parse_sheet_title(self, cell, path):
    ...
    description_en = self.en_sheet[cell.coordinate].internal_value
    ...
    self.sheets_data[key] = {'description': description, 'path': path, 'metadata': {'description_en': description_en}}
